...
const Loging = () => {
    return (
        <>
            <div id="iniciarSesion" className="bg-white">
                <div className="flex justify-center container mx-auto my-auto w-screen h-screen items-center flex-col">
                    <div className="text-slate-100 items-center">
                        ...
                        <div className="title text-center pb-3 text-3xl text-purple">Iniciar Sesión</div>
                    </div>
                    <div className=" txt2 w-full md:w-3/4  lg:w-1/2 flex flex-col items-center bg-slate-50 rounded-md pt-12">
                        ...
                        <div className="w-3/4 mb-6">
                            ...
                            <div className="txt1 flex justify-content:flex-end container mx-auto mt-6 text-slate-100 text-sm">
                                ...
                                <div>
                                    <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                                        <input
                                            ...
                                            id="checkboxDefault" />
                                        <label
                                            className="inline-block pl-[0.15rem] hover:cursor-pointer float-right"
                        ...
                        <div className="w-3/4 mb-12">
                            <button type="submit" className="inputLogin py-4 bg-green w-full rounded text-white font-bold hover:bg-blue-700 text-2xl rounded-full"> Iniciar Sesión</button>
                        </div>
                    </div>
